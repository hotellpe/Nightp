...
@guest
<div class="hLogin clear" style="margin-top: 20px;">
    <input type="text" placeholder="Username" id="top-form-user" style="border-radius: 20px; padding: 10px; border: 1px solid #ccc; margin-bottom: 10px;">
    <input type="password" placeholder="Password" id="top-form-pass" style="border-radius: 20px; padding: 10px; border: 1px solid #ccc; margin-bottom: 10px;">
    <input type="submit" value="Login"  style="border-radius: 20px; padding: 10px; background-color: #4CAF50; color: white; border: none; cursor: pointer; margin-bottom: 10px;">
